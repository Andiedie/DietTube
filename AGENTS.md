...
## 🚨 GIT SAFETY - ZERO TOLERANCE (READ THIS FIRST)

- **NEVER** create git commits unless **EXPLICITLY** requested by the user.
- **NEVER** run `git add .` or `git commit` on your own initiative.
- **NO EXCEPTIONS**: Even if you finished a task perfectly, wait for the user to ask for a commit.
- If you think a commit is good practice at a certain point, **ASK THE USER FIRST**.
